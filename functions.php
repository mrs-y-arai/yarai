...
function my_script_init()
{
	...
	wp_enqueue_style('my-css-3', get_template_directory_uri() . '/public/assets/css/common.min.css', array(), '1.0.0', 'all');
	wp_enqueue_style('my-css-2', get_template_directory_uri() . '/public/assets/css/loader.min.css', array(), '1.0.0', 'all');
	...
	wp_enqueue_script('my-js-4', get_template_directory_uri() . '/public/assets/js/vendor/pace.min.js', array(), '1.0.0', true);
	wp_enqueue_script('my-js-5', get_template_directory_uri() . '/public/assets/js/main.js', array(), '1.0.0', true);
